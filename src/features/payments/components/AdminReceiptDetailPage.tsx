...
import { getAdminReceiptByCode } from "../services/paymentService";

export function AdminReceiptDetailPage() {
  ...
  useEffect(() => {
    ...
    getAdminReceiptByCode(paymentCode, accessToken, refreshToken)
      ...
      .catch((err) => {
        if (active) setError(err instanceof Error ? err.message : "Receipt not found.");
      })
      .finally(() => {
  ...
  return (
    <CatalogShell
      ...
      description="Administrative view of member payment receipt."
      actions={
          ...
          <div className="mx-auto max-w-3xl overflow-hidden rounded-[28px] border border-[#D8DEE8] bg-white p-8 shadow-[0_26px_80px_rgba(15,23,42,0.08)] md:p-12">
            ...
            <div className="mt-12 flex flex-col justify-between gap-6 border-t border-[#E1E6F0] pt-8 md:flex-row md:items-center">
              ...
              <div className="text-sm font-medium italic text-[#59637A]">
                Official Record • Administrator Access
              </div>
            </div>
